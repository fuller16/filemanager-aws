...
<form action="" method="post" class="pt-3">
 ...
 echo($is_link ? ' &rarr; <i>' . readlink($path . '/' . $f) . '</i>' : '') ?></div>
                            </td>
    ...
    if(isset($get_first[0])){
        if ($get_first[0] != 'Orders'){
            ...
            <a title="<?php
                ...
                echo urlencode($f) ?>" style="float: right;"> <i class="fa fa-trash-o" aria-hidden="true"></i></a>
            <?php
        }
    }
    else{
...
<?php
 ...
 echo lng('Delete') ?>" href="?p=<?php
 echo urlencode(FM_PATH) ?>&amp;del=<?php
 echo urlencode($f) ?>" style="float: right;"> <i class="fa fa-trash-o"></i></a>
 <?php
 endif; ?>
                            </td>
                        </tr>
 ...
 echo lng('PartitionSize').': <span class="badge badge-light">'.fm_get_filesize(@disk_free_space($path)) .'</span> '.lng('FreeOf').' <span class="badge badge-light">'.fm_get_filesize(@disk_total_space($path)).'</span>'; ?>
        ...
        <div class="col-md-6">
            <div class="iframe-responsive" >
                ...
                <div id="loadImg"><div><img src="ajax-loader.gif"/></div></div>
                <iframe src="" name="iframe_a" id="iframelink" width="100%" title="Preview Files" onload="document.getElementById('loadImg').style.display='none';"></iframe>
            </div>
        </div>
    </div>
 ...
 echo lng('Delete') ?> </a></li>
        ...
        ?>
        <li class="list-inline-item"><input type="submit" class="hidden" name="delete" id="a-delete" value="Delete" style="float: right;">
                    <a href="javascript:document.getElementById('a-delete').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-trash"></i> <?php
 echo lng('Delete') ?> </a></li>
        <?php
    }
 ...
 echo APP_TITLE; ?></a></div> -->
        <?php
            ...
            <!-- <div class="col-12"><a href="https://onpoint.pinpoint.promo/" target="_blank" class="float-right text-muted"><?php
 echo APP_TITLE; ?></a></div> -->
        <?php
 endif; ?>
    </div>
...
<script>
    ...
    function previewlink($this){
        ...
        var _theframe = document.getElementById("iframelink");
        _theframe.src=$($this).attr('href')+"?random="+ (new Date()).getTime() + Math.floor(Math.random() * 1000000);
    }
    ...
    $(document).ready( function () {
        ...
        $('body').on('click','.edit_text_file',function(e){
        e.preventDefault()
